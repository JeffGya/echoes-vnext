...
### Deferred
- XP rank-up logic (level 5 → rank 2, trait drift) — PROG-004
- Dominant Vector display in Echo Manage detail view — PROG-004
- Wisdom/faith virtue XP multipliers — PROG-004 (courage only in PROG-003)
