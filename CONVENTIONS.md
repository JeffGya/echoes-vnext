...
| PartyManageScreen | `flow.party_manage` | max_party_size (5), roster (id/name/rank/level/in_party/archetype/calling/calling_eligible), active_party_ids | back, primary (sanctum.party.confirm, enabled when pending≥1) |
