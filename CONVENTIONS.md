...
- Types: `TYPE_COMBAT`, `TYPE_NPC`, `TYPE_LOOT`, `TYPE_MONEY`. `SITUATION_TYPE_POOL` weighted array (combat×3, npc×2, loot×2, money×1). **V2-STAGE-002:** objective situations inherit type from the matching objective (combat/shrine/recover/protect/endure/pursue).
